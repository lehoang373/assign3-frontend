    ...
    <v-container fluid>
      <v-row align="center" justify="center">
        <v-col cols="12" align="center" justify="center">
          <blockquote style="color: white; font-size: xx-large">
      ...
      <v-row align="center" justify="center">
        <v-col cols="12" md="10" v-resize="onResize">
          ...
          <v-btn class="green mt-4 white--text" @click="addNewStock" v-show="isSuperUser">Add Stock</v-btn>
        </v-col>
      </v-row>
    </v-container>
  </v-main>
...
<style scoped>
.appbackground {
  background: url('../assets/images/stocks.jpg');
  ...
  methods: {
    ...
    getStocks() {
      apiService.getStockList().then(response => {
        ...
        if(response.data.isSuperUser==='false'){
